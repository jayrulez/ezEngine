...
public:
    ...
    std::shared_ptr<Resource> CreateTexture(TextureType type, uint32_t bind_flag, ResourceFormat::Enum format, uint32_t sample_count, int width, int height, int depth, int mip_levels) override;
