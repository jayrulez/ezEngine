...
struct EZ_RHI_DLL RasterizerState
{
...
struct EZ_RHI_DLL DepthStencilState
{
...
struct EZ_RHI_DLL GPUQueryHeapDesc
{
...
struct EZ_RHI_DLL SwapChainDesc
{
...
struct EZ_RHI_DLL Shader : public GraphicsDeviceChild
{
  ...
  ezDynamicArray<StaticSampler> auto_samplers; // ability to set static samplers without explicit root signature
};
...
struct EZ_RHI_DLL GPUQueryHeap : public GraphicsDeviceChild
{
...
struct EZ_RHI_DLL SwapChain : public GraphicsDeviceChild
{
  SwapChainDesc desc;
