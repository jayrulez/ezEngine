...
void RHICommandList::SetPipeline(RHIPipeline* pipeline)
{
...
void RHICommandList::SetVertexBuffer(ezUInt32 index, RHIBuffer* buffer)
{
...
void RHICommandList::SetVertexBuffer(ezUInt32 index, RHIBuffer* buffer, ezUInt32 offset)
{
...
void RHICommandList::SetIndexBuffer(RHIBuffer* buffer, ezEnum<RHIIndexFormat> format)
{
...
void RHICommandList::SetIndexBuffer(RHIBuffer* buffer, ezEnum<RHIIndexFormat> format, ezUInt32 offset)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
...
void RHICommandList::SetGraphicsResourceSet(ezUInt32 slot, RHIResourceSet* resourceSet)
{
...
void RHICommandList::SetGraphicsResourceSet(ezUInt32 slot, RHIResourceSet* resourceSet, const ezDynamicArray<ezUInt32>& dynamicOffsets)
{
...
void RHICommandList::SetGraphicsResourceSet(ezUInt32 slot, RHIResourceSet* resourceSet, ezUInt32 dynamicOffsetsCount, const ezDynamicArray<ezUInt32>& dynamicOffsets)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
...
void RHICommandList::SetComputeResourceSet(ezUInt32 slot, RHIResourceSet* resourceSet)
{
...
void RHICommandList::SetComputeResourceSet(ezUInt32 slot, RHIResourceSet* resourceSet, const ezDynamicArray<ezUInt32>& dynamicOffsets)
{
...
void RHICommandList::SetComputeResourceSet(ezUInt32 slot, RHIResourceSet* resourceSet, ezUInt32 dynamicOffsetsCount, const ezDynamicArray<ezUInt32>& dynamicOffsets)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
...
void RHICommandList::SetFramebuffer(RHIFramebuffer* framebuffer)
{
...
void RHICommandList::ClearColorTarget(ezUInt32 index, ezColor clearColor)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
...
void RHICommandList::ClearDepthStencil(float depth)
{
...
void RHICommandList::ClearDepthStencil(float depth, ezUInt8 stencil)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
  if (m_pFramebuffer == nullptr)
  {
...
void RHICommandList::SetFullViewports()
{
...
void RHICommandList::SetFullViewport(ezUInt32 index)
{
  SetViewport(index, RHIViewport(0, 0, (float)m_pFramebuffer->GetWidth(), (float)m_pFramebuffer->GetHeight(), 0, 1));
}
...
void RHICommandList::SetViewport(ezUInt32 index, const RHIViewport& viewport)
{
...
void RHICommandList::SetFullScissorRects()
{
...
void RHICommandList::SetFullScissorRect(ezUInt32 index)
{
  SetScissorRect(index, 0, 0, m_pFramebuffer->GetWidth(), m_pFramebuffer->GetHeight());
}
...
void RHICommandList::SetScissorRect(ezUInt32 index, ezUInt32 x, ezUInt32 y, ezUInt32 width, ezUInt32 height)
{
...
void RHICommandList::Draw(ezUInt32 vertexCount)
{
...
void RHICommandList::Draw(ezUInt32 vertexCount, ezUInt32 instanceCount, ezUInt32 vertexStart, ezUInt32 instanceStart)
{
  PreDrawValidation();
...
void RHICommandList::DrawIndexed(ezUInt32 indexCount)
{
...
void RHICommandList::DrawIndexed(ezUInt32 indexCount, ezUInt32 instanceCount, ezUInt32 indexStart, ezInt32 vertexOffset, ezUInt32 instanceStart)
{
...
void RHICommandList::DrawIndirect(RHIBuffer* indirectBuffer, ezUInt32 offset, ezUInt32 drawCount, ezUInt32 stride)
{
...
void RHICommandList::DrawIndexedIndirect(RHIBuffer* indirectBuffer, ezUInt32 offset, ezUInt32 drawCount, ezUInt32 stride)
{
  ValidateDrawIndirectSupport();
  ValidateIndirectBuffer(indirectBuffer);
  ValidateIndirectOffset(offset);
...
void RHICommandList::Dispatch(ezUInt32 groupCountX, ezUInt32 groupCountY, ezUInt32 groupCountZ)
{
...
void RHICommandList::DispatchIndirect(RHIBuffer* indirectBuffer, ezUInt32 offset)
{
  ValidateIndirectBuffer(indirectBuffer);
  ValidateIndirectOffset(offset);
...
void RHICommandList::ResolveTexture(RHITexture* source, RHITexture* destination)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
...
void RHICommandList::UpdateBuffer(RHIBuffer* buffer, ezUInt32 bufferOffset, ezUInt8* source, ezUInt32 size)
{
...
void RHICommandList::CopyBuffer(RHIBuffer* source, ezUInt32 sourceOffset, RHIBuffer* destination, ezUInt32 destinationOffset, ezUInt32 size)
{
  if (size == 0)
  {
    return;
...
void RHICommandList::CopyTexture(RHITexture* source, RHITexture* destination)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
  ...
  for (ezUInt32 level = 0; level < source->GetMipLevels(); level++)
  {
    ...
    ezUInt32 mipHeight;
    ezUInt32 mipDepth;
    Util::GetMipDimensions(source, level, mipWidth, mipHeight, mipDepth);
...
void RHICommandList::CopyTexture(RHITexture* source, RHITexture* destination, ezUInt32 mipLevel, ezUInt32 arrayLayer)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
  ezUInt32 effectiveSrcArrayLayers = (source->GetUsage() & RHITextureUsage::Cubemap) != 0
                                       ? source->GetArrayLayers() * 6
  ...
  ezUInt32 height;
  ezUInt32 depth;
  Util::GetMipDimensions(source, mipLevel, width, height, depth);
  CopyTexture(
...
void RHICommandList::CopyTexture(RHITexture* source, ezUInt32 srcX, ezUInt32 srcY, ezUInt32 srcZ, ezUInt32 srcMipLevel, ezUInt32 srcBaseArrayLayer, RHITexture* destination, ezUInt32 dstX, ezUInt32 dstY, ezUInt32 dstZ, ezUInt32 dstMipLevel, ezUInt32 dstBaseArrayLayer, ezUInt32 width, ezUInt32 height, ezUInt32 depth, ezUInt32 layerCount)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
  ...
  Util::GetMipDimensions(source, srcMipLevel, srcWidth, srcHeight, srcDepth);
  ezUInt32 srcBlockSize = FormatHelpers::IsCompressedFormat(source->GetFormat()) ? 4u : 1u;
  ...
  Util::GetMipDimensions(destination, dstMipLevel, dstWidth, dstHeight, dstDepth);
  ezUInt32 dstBlockSize = FormatHelpers::IsCompressedFormat(destination->GetFormat()) ? 4u : 1u;
...
void RHICommandList::GenerateMipmaps(RHITexture* texture)
{
...
void RHICommandList::PushDebugGroup(ezString name)
{
...
void RHICommandList::PopDebugGroup()
{
  PopDebugGroupCore();
}
...
void RHICommandList::InsertDebugMarker(ezString name)
{
  InsertDebugMarkerCore(name);
}

void RHICommandList::ValidateIndirectOffset(ezUInt32 offset)
{
  if ((offset % 4) != 0)
  {
...
void RHICommandList::ValidateDrawIndirectSupport()
{
...
void RHICommandList::ValidateIndirectBuffer(RHIBuffer* indirectBuffer)
{
...
void RHICommandList::ValidateIndirectStride(ezUInt32 stride, ezUInt32 argumentSize)
{
...
void RHICommandList::ValidateIndexBuffer(ezUInt32 indexCount)
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
...
void RHICommandList::PreDrawValidation()
{
#if EZ_ENABLED(EZ_COMPILE_FOR_DEVELOPMENT)
  if (m_pGraphicsPipeline == nullptr)
  {
