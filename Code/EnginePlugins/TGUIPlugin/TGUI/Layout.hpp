...
namespace tgui
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class EZ_TGUIPLUGIN_DLL Layout
    {
    public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class EZ_TGUIPLUGIN_DLL Layout2d
    {
    public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    EZ_TGUIPLUGIN_DLL Layout operator-(Layout right);

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief + operator for the Layout class
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    EZ_TGUIPLUGIN_DLL Layout operator+(Layout left, Layout right);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    EZ_TGUIPLUGIN_DLL Layout2d operator-(Layout2d right);

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief + operator for the Layout2d class
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    EZ_TGUIPLUGIN_DLL Layout2d operator+(Layout2d left, Layout2d right);
    ...
    /// @brief * operator for the Layout2d class
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    EZ_TGUIPLUGIN_DLL Layout2d operator*(Layout2d left, const Layout& right);

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// @brief * operator for the Layout2d class
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    EZ_TGUIPLUGIN_DLL Layout2d operator*(const Layout& left, Layout2d right);
    ...
    inline namespace bind_functions
    {
        ...
        EZ_TGUIPLUGIN_DLL Layout bindLeft(std::shared_ptr<Widget> widget);

        /// @brief Bind to the y position of the widget
        EZ_TGUIPLUGIN_DLL Layout bindTop(std::shared_ptr<Widget> widget);

        /// @brief Bind to the width of the widget
        EZ_TGUIPLUGIN_DLL Layout bindWidth(std::shared_ptr<Widget> widget);

        /// @brief Bind to the height of the widget
        EZ_TGUIPLUGIN_DLL Layout bindHeight(std::shared_ptr<Widget> widget);

        /// @brief Bind to the inner width of the container widget
        EZ_TGUIPLUGIN_DLL Layout bindInnerWidth(std::shared_ptr<Container> container);

        /// @brief Bind to the inner height of the container widget
        EZ_TGUIPLUGIN_DLL Layout bindInnerHeight(std::shared_ptr<Container> container);

        /// @brief Bind to the right position of the widget
        EZ_TGUIPLUGIN_DLL Layout bindRight(std::shared_ptr<Widget> widget);

        /// @brief Bind to the bottom of the widget
        EZ_TGUIPLUGIN_DLL Layout bindBottom(std::shared_ptr<Widget> widget);

        /// @brief Bind to the position of the widget
        EZ_TGUIPLUGIN_DLL Layout2d bindPosition(std::shared_ptr<Widget> widget);

        /// @brief Bind to the size of the widget
        EZ_TGUIPLUGIN_DLL Layout2d bindSize(std::shared_ptr<Widget> widget);

        /// @brief Bind to the inner size of the container widget
        EZ_TGUIPLUGIN_DLL Layout2d bindInnerSize(std::shared_ptr<Container> container);

        /// @brief Bind to the width of the gui view
        EZ_TGUIPLUGIN_DLL Layout bindWidth(GuiBase& gui);

        /// @brief Bind to the height of the gui view
        EZ_TGUIPLUGIN_DLL Layout bindHeight(GuiBase& gui);

        /// @brief Bind to the size of the gui view
        EZ_TGUIPLUGIN_DLL Layout2d bindSize(GuiBase& gui);

        /// @brief Bind to the minimum value of two layouts
        EZ_TGUIPLUGIN_DLL Layout bindMin(const Layout& value1, const Layout& value2);

        /// @brief Bind to the maximum value of two layouts
        EZ_TGUIPLUGIN_DLL Layout bindMax(const Layout& value1, const Layout& value2);
    }
