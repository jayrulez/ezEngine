...
#include <TGUIPlugin/TGUI/Duration.hpp>
#include <functional>
#include <memory>
...
namespace tgui
{
    ...
    namespace priv
    {
        ...
        class EZ_TGUIPLUGIN_DLL Animation
        {
        public:
            enum class Type
            {
        ...
        class EZ_TGUIPLUGIN_DLL MoveAnimation : public Animation
        {
        public:
        ...
        class EZ_TGUIPLUGIN_DLL ResizeAnimation : public Animation
        {
        public:
        ...
        class EZ_TGUIPLUGIN_DLL FadeAnimation : public Animation
        {
        public:
